...
// Halaman utama (Home)
if ($_GET[module]=='home'){
  echo "<div class='center_title_bar'>Produk </div>";
...
elseif ($_GET[module]=='detailproduk'){
  ...
  echo "<div class='center_title_bar'>Kategori: <a href='kategori-$d[id_kategori]-$d[kategori_seo].html'>$d[nama_kategori]</a></div>
        ...
        <div class='center_prod_box_big'>            
                 ...
                 <a href='#'><img src='foto_produk/$d[gambar]' border='0' style='max-width:180px; height:auto'/></a>
          ...
          <div class='details_big_box'>
            <div class='product_title_big'>$d[nama_produk]</div>
              <div>$d[deskripsi]</div><br>
              <h3> Rate : </h3><br>

              <form action='rate.php' method='POST'>
              <input type='hidden' name='id_produk' value='$d[id_produk]'> 
              <input type='hidden' name='id_plg' value='$_SESSION[id_plg]'> 
              <label>1</label> 
...
// Produk Lainnya (random)          
  ...
  echo "<div class='center_title_bar'>Rekomendasi Produk Lainnya</div>";
...
elseif ($_GET[module]=='profilkami'){
  ...
  echo "<div class='center_title_bar'>Profil</div>
          ...
          <div class='details_big_box'>
            <div class='product_title_big'>Profil Atlanta Elektronik</div>
...
for ($i = 0; $i < $jml; $i++) {
  ...
  echo "<div class='center_title_bar'>Proses Transaksi Selesai</div>";
      ...
      Silahkan lakukan pembayaran ke BCA sebanyak Grand Total yang tercantum, nomor rekening <b>12345678</b> a.n. Atlanta Elektonik";
...
$pesan="Terimakasih telah melakukan pemesanan online di Atlanta Elektronik <br /><br />  
        Nama: $nama <br />
        Alamat: $alamat <br/>
        Telpon: $telpon <br /><hr />
...
$pesan.="<br /><br />Total : Rp. $total_rp 
         ...
         nomor rekeningnya <b>12345678</b> a.n. Atlanta Elektonik";

$subjek="Pemesanan Online Atlanta Elektronik";
...
echo "<hr /><p>
               Apabila Anda tidak melakukan pembayaran dalam 1 hari, maka transaksi dianggap batal</p><br />      
              </div>
          </div>    
          </div>
            <div class='bottom_prod_box_big'></div>

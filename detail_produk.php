...
<meta http-equiv="Copyright" content="bagusrivaldi">
<meta name="author" content="Bagus Rivaldi">
...
<div id="main_container">
  ...
  <div class="left_content"> 
   ...
   <?php 
   $produk_id=$_GET['id'];
   $produk=mysql_query("SELECT * FROM produk WHERE id_produk = '$produk_id'");
   $data=mysql_fetch_array($produk);
  //  var_dump($data);die;
   ?>
<!-- <div class="center_title_bar">Kategori: <a href="kategori-10-harddisk.html">Harddisk</a></div> -->
    	  <div class="prod_box_big">
        	<div class="top_prod_box_big"></div>
        <div class="center_prod_box_big">            
                 <div class="product_img_big">
                 <a href="#"><img src="foto_produk/<?= $data['gambar'];?>" border="0"></a>
            <div class="prod_price_big"><span class="price">Rp. <?= format_rupiah($data['harga']);?></span></div>
            <p align="center">(stok:<?= $data['stok'] ?>)</p>
            <a href="aksi.php?module=keranjang&amp;act=tambah&amp;id=<?= $data['id_produk'];?>" class="addtocart">beli</a>
            </div>
          <div class="details_big_box">
            <div class="product_title_big"><?= $data['nama_produk'];?></div>
              <div><span style="font-family: Arial; font-size: 12px; text-align: left"><?= $data['deskripsi'];?></span>
</div>
          </div>    
          </div>
